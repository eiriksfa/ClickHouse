...
If turned on, `SELECT` queries may utilize the [query cache](../query-cache.md). Parameters [use_query_cache_passive_usage](#use-query-cache-passive-usage)
and [use_query_cache_active_usage](#use-query-cache-active-usage) control in more detail how the cache is used.
...
## use_query_cache_passive_usage {#use-query-cache-passive-usage}
...
## use_query_cache_active_usage {#use-query--active-usage}
