...
#define COMMON_SETTINGS(M) \
    ...
    M(Bool, use_query_cache_active_usage, true, "Utilize the query cache actively, i.e. store results of SELECT queries in the cache", 0) \
    M(Bool, use_query_cache_passive_usage, true, "Utilize the query cache passively, i.e. retrieve results of SELECT queries from the cache", 0) \
